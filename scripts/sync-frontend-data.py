...
def make(row):
    ...
    return {
        ...
        "mezclado_por":str(row.get("mezclado_por") or row.get("blended_por") or "").strip() or "No especificado en la fuente",
        "fabricante":str(row.get("fabricante") or row.get("fabricado_por") or "").strip() or "No especificado en la fuente",
